-- datatypes, deprecated/replacement and other => 
    ...
    https://learn.microsoft.com/en-us/sql/database-engine/deprecated-database-engine-features-in-sql-server-2022?view=sql-server-ver16
