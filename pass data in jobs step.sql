...
/****** Object:  Job [DoProceed]    Script Date: 7/1/2022 3:25:12 PM ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [[Uncategorized (Local)]]    Script Date: 7/1/2022 3:25:13 PM ******/
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [check period]    Script Date: 7/1/2022 3:25:13 PM ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'check period', 
		...
		@command=N'declare @proceed nchar(3) 
...
raiserror (''Notification @proceed = %s'', 10, 1, @proceed) with log;

', 
		@database_name=N'master', 
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Proceed]    Script Date: 7/1/2022 3:25:13 PM ******/
...
', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [reset the last top 1]    Script Date: 7/1/2022 3:25:13 PM ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'reset the last top 1', 
		@step_id=3, 
		@cmdexec_success_code=0, 
		@on_success_action=1, 
		@on_success_step_id=0, 
...
set @proceed = N''No''
--the previous define Yes this one will create a row with No hidnf the Yes to be the top 1 at step 2
raiserror (''Notification @proceed = %s'', 10, 1, @proceed) with log;
', 
		@database_name=N'master', 
		@flags=0
